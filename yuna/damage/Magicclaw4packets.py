...
# ============================================================
# MAGIC CLAW - AL EERDER BEVESTIGD
# ============================================================
...
#                3 = x4
#
# ctrl + 0x04 = Magic Claw packets intercepted
...
def build_trampoline(
    ...
    mode=1 -> downstream 2 keer totaal
    ...
    # --------------------------------------------------------
    # Exact Magic Claw fingerprint.
    #
    # payload:
    #   +0 WORD  opcode
    #   +3 BYTE  target/hit packed value
    #   +4 DWORD skill id
    # --------------------------------------------------------
...
def main():
    ...
    print(
        "F3  = OFF / restore original SendPacket E9"
    )
